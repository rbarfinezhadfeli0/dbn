# Documentation: rust/dbn-macros/tests/ui/missing_rtype.rs

## File Metadata

**Path:** `rust/dbn-macros/tests/ui/missing_rtype.rs`
**Filename:** `missing_rtype.rs`
**Extension:** `.rs`
**Type:** Text

## Original Source

**Location:** `../../../../../rust/dbn-macros/tests/ui/missing_rtype.rs`
...
This file is located at `rust/dbn-macros/tests/ui/missing_rtype.rs` within the repository.
