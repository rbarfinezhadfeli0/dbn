# Documentation: rust/dbn-macros/tests/ui/csv_serialize_invalid_dbn_attr.stderr

## File Metadata

**Path:** `rust/dbn-macros/tests/ui/csv_serialize_invalid_dbn_attr.stderr`
**Filename:** `csv_serialize_invalid_dbn_attr.stderr`
**Extension:** `.stderr`
**Type:** Text

## Original Source

**Location:** `../../../../../rust/dbn-macros/tests/ui/csv_serialize_invalid_dbn_attr.stderr`
...
This file is located at `rust/dbn-macros/tests/ui/csv_serialize_invalid_dbn_attr.stderr` within the repository.
