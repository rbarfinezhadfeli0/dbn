# Documentation: rust/dbn-cli/tests/integration_tests.rs
...
**Location:** `../../../../rust/dbn-cli/tests/integration_tests.rs`
...
This file is located at `rust/dbn-cli/tests/integration_tests.rs` within the repository.
...
**Functions defined:** bad_infer, broken_pipe_is_silent, cant_specify_json_and_csv, cmd, convert_dbz_to_dbn, empty, encoding_overrides_extension, force_overwrite, force_truncates_file, fragment_conflicts_with_dbn_output, fragment_conflicts_with_metadata, help, input_fragment, limit_and_schema_filter_update_metadata, map_symbols, map_symbols_fails_for_invalid_output, metadata, no_csv_metadata, no_extension_infer, omit_csv_header
...
##### Function: `write_to_nonexistent_path`
...
##### Function: `read_from_nonexistent_path`
...
##### Function: `encoding_overrides_extension`
