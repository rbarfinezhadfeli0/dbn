# Documentation: rust/dbn/src/v2.rs
...
This file is located at `rust/dbn/src/v2.rs` within the repository.
...
**Functions defined:** asset, channel_id, end_ts, from, raw_symbol, security_type, security_update_action, start_ts, stype_in_symbol, stype_out_symbol
