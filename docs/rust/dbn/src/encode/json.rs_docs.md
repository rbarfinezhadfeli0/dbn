# Documentation: rust/dbn/src/encode/json.rs
...
**Location:** `../../../../../rust/dbn/src/encode/json.rs`
...
This file is located at `rust/dbn/src/encode/json.rs` within the repository.
