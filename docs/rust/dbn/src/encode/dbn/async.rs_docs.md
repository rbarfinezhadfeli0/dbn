# Documentation: rust/dbn/src/encode/dbn/async.rs

## File Metadata

**Path:** `rust/dbn/src/encode/dbn/async.rs`
**Filename:** `async.rs`
**Extension:** `.rs`
**Type:** Text
...
**Location:** `../../../../../../rust/dbn/src/encode/dbn/async.rs`
...
This file is located at `rust/dbn/src/encode/dbn/async.rs` within the repository.
...
**Functions defined:** encode, encode_date, encode_fixed_len_cstr, encode_range_and_counts, encode_record, encode_record_ref, encode_ref, encode_repeated_symbol_cstr, encode_symbol_mapping, encode_symbol_mappings, flush, from, get_mut, get_ref, into_inner, new, shutdown, test_encode_date, test_encode_decode_metadata_identity, test_encode_decode_nulls
