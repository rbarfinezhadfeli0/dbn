# Documentation: rust/dbn/src/encode/dbn/sync.rs

## File Metadata

**Path:** `rust/dbn/src/encode/dbn/sync.rs`
**Filename:** `sync.rs`
**Extension:** `.rs`
**Type:** Text
...
**Location:** `../../../../../../rust/dbn/src/encode/dbn/sync.rs`
...
This file is located at `rust/dbn/src/encode/dbn/sync.rs` within the repository.
...
**Functions defined:** calc_length, encode, encode_date, encode_fixed_len_cstr, encode_range_and_counts, encode_record, encode_record_ref, encode_record_ref_ts_out, encode_repeated_symbol_cstr, encode_symbol_mapping, encode_symbol_mappings, flush, get_mut, get_ref, new, test_encode_date, test_encode_decode_metadata_identity, test_encode_decode_nulls, test_encode_fixed_len_cstr, test_encode_repeated_symbol_cstr

**Structs defined:** Encoder, MetadataEncoder, RecordEncoder
...
##### Function: `encode_record_ref_ts_out`

```rust
fn encode_record_ref_ts_out(&mut self, record: RecordRef, ts_out: bool) -> Result<()> {
```
