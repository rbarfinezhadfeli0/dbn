# Documentation: rust/dbn/src/encode/json/sync.rs

## File Metadata

**Path:** `rust/dbn/src/encode/json/sync.rs`
**Filename:** `sync.rs`
**Extension:** `.rs`
**Type:** Text
...
**Location:** `../../../../../../rust/dbn/src/encode/json/sync.rs`
...
This file is located at `rust/dbn/src/encode/json/sync.rs` within the repository.
...
**Functions defined:** build, builder, encode_metadata, encode_record, encode_record_ref, encode_record_ref_ts_out, encode_record_with_sym, flush, get_mut, get_ref, new, should_pretty_print, test_encode_ref_with_sym, test_encode_with_ts_out, test_imbalance_write_json, test_instrument_def_write_json, test_mbo_write_json, test_mbp10_write_json, test_mbp1_write_json, test_metadata_write_json

**Structs defined:** Encoder, EncoderBuilder
