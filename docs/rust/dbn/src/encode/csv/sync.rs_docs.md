# Documentation: rust/dbn/src/encode/csv/sync.rs
...
**Location:** `../../../../../../rust/dbn/src/encode/csv/sync.rs`
...
This file is located at `rust/dbn/src/encode/csv/sync.rs` within the repository.
...
**Functions defined:** bid_ask, build, builder, delimiter, encode_decoded, encode_decoded_with_limit, encode_header, encode_header_for_schema, encode_record, encode_record_impl, encode_record_ref, encode_record_ref_ts_out, encode_record_with_sym, encode_records, encode_stream, encode_symbol, extract_2nd_line, flush, get_ref, header
