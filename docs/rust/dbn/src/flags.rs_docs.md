# Documentation: rust/dbn/src/flags.rs

## File Metadata

**Path:** `rust/dbn/src/flags.rs`
**Filename:** `flags.rs`
**Extension:** `.rs`
**Type:** Text
...
**Location:** `../../../../rust/dbn/src/flags.rs`
...
This file is located at `rust/dbn/src/flags.rs` within the repository.
...
**Functions defined:** any, clear, dbg, empty, fmt, from, is_bad_ts_recv, is_empty, is_last, is_maybe_bad_book, is_mbp, is_snapshot, is_tob, new, raw, set_bad_ts_recv, set_last, set_maybe_bad_book, set_mbp, set_raw

**Structs defined:** FlagSet
