# Documentation: rust/dbn/src/compat.rs

## File Metadata

**Path:** `rust/dbn/src/compat.rs`
**Filename:** `compat.rs`
**Extension:** `.rs`
**Type:** Text
...
**Location:** `../../../../rust/dbn/src/compat.rs`
...
This file is located at `rust/dbn/src/compat.rs` within the repository.
...
**Functions defined:** asset, channel_id, choose_record_ref, decode_record_ref, end_ts, raw_symbol, security_type, security_update_action, start_ts, stype_in_symbol, stype_out_symbol, test_strike_price_order_didnt_change, upgrade_mbp1_ts_out, upgrade_record, upgrade_symbol_mapping_ts_out, version_symbol_cstr_len

**Structs defined:** ErrorMsgV1, InstrumentDefMsgV1, InstrumentDefMsgV3, SymbolMappingMsgV1, SystemMsgV1

**Traits defined:** InstrumentDefRec, SymbolMappingRec, for

**Dependencies:** This file imports from 12 modules


#### Detailed Walkthrough


##### Function: `version_symbol_cstr_len`

```rust
fn version_symbol_cstr_len(version: u8) -> usize {
```
...
##### Function: `choose_record_ref`

```rust
fn choose_record_ref<'a>(
    version: u8,
    upgrade_policy: VersionUpgradePolicy,
    buffer: &'a [u8],
    compat_buffer: &'a [u8],
...
##### Function: `upgrade_record`

```rust
fn upgrade_record<'a, T, U>(
    ts_out: bool,
    compat_buffer: &'a mut [u8; crate::MAX_RECORD_LEN],
    input: &'a [u8],
) -> RecordRef<'a>
...
##### Function: `test_strike_price_order_didnt_change`
...
##### Function: `upgrade_symbol_mapping_ts_out`
