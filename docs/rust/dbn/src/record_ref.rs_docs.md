# Documentation: rust/dbn/src/record_ref.rs

## File Metadata

**Path:** `rust/dbn/src/record_ref.rs`
**Filename:** `record_ref.rs`
**Extension:** `.rs`
**Type:** Text

## Original Source

**Location:** `../../../../rust/dbn/src/record_ref.rs`
...
This file is located at `rust/dbn/src/record_ref.rs` within the repository.
...
**Functions defined:** as_enum, as_ref, fmt, from, get, get_unchecked, has, header, new, raw_index_ts, test_as_ref, test_fmt_debug, test_get_too_short, test_has_and_get, test_header, unchecked_from_header

**Structs defined:** RecordRef, for
...
##### Function: `unchecked_from_header`

```rust
fn unchecked_from_header(header: *const RecordHeader) -> Self {
```
...
```rust
fn get_unchecked<T: HasRType>(&self) -> &'a T {
```
