# Documentation: rust/dbn/src/decode/dbn/sync.rs

## File Metadata

**Path:** `rust/dbn/src/decode/dbn/sync.rs`
**Filename:** `sync.rs`
**Extension:** `.rs`
**Type:** Text
...
**Location:** `../../../../../../rust/dbn/src/decode/dbn/sync.rs`
...
This file is located at `rust/dbn/src/decode/dbn/sync.rs` within the repository.
...
**Functions defined:** buffer_slice, compat_buffer_slice, decode, decode_iso8601, decode_metadata_fields, decode_record, decode_record_ref, decode_ref, decode_repeated_symbol_cstr, decode_stream, decode_symbol, decode_symbol_mapping, decode_symbol_mappings, from_file, from_zstd_file, get_mut, get_ref, into_inner, metadata, metadata_mut

**Structs defined:** Decoder, MetadataDecoder, RecordDecoder
