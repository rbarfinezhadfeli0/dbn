# Documentation: rust/dbn/src/decode/dbn/async.rs

## File Metadata

**Path:** `rust/dbn/src/decode/dbn/async.rs`
**Filename:** `async.rs`
**Extension:** `.rs`
**Type:** Text
...
**Location:** `../../../../../../rust/dbn/src/decode/dbn/async.rs`
...
This file is located at `rust/dbn/src/decode/dbn/async.rs` within the repository.
...
**Functions defined:** advance, buffer_reserve, clear, decode, decode_head, decode_record, decode_record_ref, decode_ref, dummy_buffer, frame_decoder_decode, frame_decoder_decode_head, frame_decoder_validate_len, from, from_file, from_zstd_file, get_mut, into_inner, metadata, new, remaining

**Structs defined:** Decoder, MetadataDecoder, RecordDecoder

**Enums defined:** DecoderState, RecordFramer

**Traits defined:** Buffer
