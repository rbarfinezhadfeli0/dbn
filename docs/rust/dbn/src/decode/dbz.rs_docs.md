# Documentation: rust/dbn/src/decode/dbz.rs

## File Metadata

**Path:** `rust/dbn/src/decode/dbz.rs`
**Filename:** `dbz.rs`
**Extension:** `.rs`
**Type:** Text
...
**Location:** `../../../../../rust/dbn/src/decode/dbz.rs`
...
This file is located at `rust/dbn/src/decode/dbz.rs` within the repository.
...
**Functions defined:** buffer_slice, compat_buffer_slice, decode, decode_record, decode_record_ref, decode_repeated_symbol_cstr, decode_stream, decode_symbol, decode_symbol_mapping, decode_symbol_mappings, from_file, metadata, metadata_mut, new, read, record_ref, starts_with_prefix, test_decode_stream, test_decode_symbol, test_decode_symbol_invalid_utf8

**Structs defined:** Decoder, MetadataDecoder
