# Documentation: rust/dbn/src/decode/merge.rs

## File Metadata

**Path:** `rust/dbn/src/decode/merge.rs`
**Filename:** `merge.rs`
**Extension:** `.rs`
**Type:** Text
...
**Location:** `../../../../../rust/dbn/src/decode/merge.rs`
...
This file is located at `rust/dbn/src/decode/merge.rs` within the repository.
...
**Functions defined:** buffer_slice, compat_buffer_slice, decode_record, decode_record_ref, decode_stream, metadata, metadata_mut, new, new_mbp1, peek_decoder_idx, record_ref, stream_merging, stream_merging_w_empty

**Structs defined:** Decoder, RecordDecoder, StreamHead
