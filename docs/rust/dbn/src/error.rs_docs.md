# Documentation: rust/dbn/src/error.rs

## File Metadata

**Path:** `rust/dbn/src/error.rs`
**Filename:** `error.rs`
**Extension:** `.rs`
**Type:** Text
...
**Location:** `../../../../rust/dbn/src/error.rs`
...
This file is located at `rust/dbn/src/error.rs` within the repository.
...
**Functions defined:** conversion, decode, encode, from, io, opt_pos, silence_eof_error, utf8
...
##### Function: `silence_eof_error`

```rust
fn silence_eof_error<T>(err: std::io::Error) -> std::io::Result<Option<T>> {
```
