# Documentation: rust/dbn/src/enums.rs

## File Metadata

**Path:** `rust/dbn/src/enums.rs`
**Filename:** `enums.rs`
**Extension:** `.rs`
**Type:** Text
...
**Location:** `../../../../rust/dbn/src/enums.rs`
...
This file is located at `rust/dbn/src/enums.rs` within the repository.
...
**Functions defined:** as_ref, as_str, deserialize, fmt, from, from_str, is_future, is_option, is_spread, serialize, try_into_schema, validate_schema_count

**Enums defined:** Action, Compression, Encoding, InstrumentClass, MatchAlgorithm, RType, SType, Schema, SecurityUpdateAction, Side, StatType, StatUpdateAction, StatusAction, StatusReason, TradingEvent, TriState, UserDefinedInstrument, VersionUpgradePolicy, for
