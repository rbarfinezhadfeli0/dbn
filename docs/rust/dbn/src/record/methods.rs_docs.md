# Documentation: rust/dbn/src/record/methods.rs

## File Metadata

**Path:** `rust/dbn/src/record/methods.rs`
**Filename:** `methods.rs`
**Extension:** `.rs`
**Type:** Text
...
**Location:** `../../../../../rust/dbn/src/record/methods.rs`
...
This file is located at `rust/dbn/src/record/methods.rs` within the repository.
...
**Functions defined:** action, activation, as_ref, ask_pb, ask_px_f64, asset, auct_interest_clr_price_f64, bid_pb, bid_px_f64, cfi, close_f64, cont_book_clr_price_f64, currency, debug_instrument_err, debug_instrument_symbol_mapping, debug_instrument_sys, debug_mbo, debug_stats, end_ts, err
