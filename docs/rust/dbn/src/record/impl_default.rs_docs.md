# Documentation: rust/dbn/src/record/impl_default.rs

## File Metadata

**Path:** `rust/dbn/src/record/impl_default.rs`
**Filename:** `impl_default.rs`
**Extension:** `.rs`
**Type:** Text

## Original Source

**Location:** `../../../../../rust/dbn/src/record/impl_default.rs`
...
This file is located at `rust/dbn/src/record/impl_default.rs` within the repository.
...
**Functions defined:** default, default_for_schema
...
```rust
fn default<R: HasRType>(rtype: u8) -> Self {
```
