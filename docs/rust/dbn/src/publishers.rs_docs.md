# Documentation: rust/dbn/src/publishers.rs

## File Metadata

**Path:** `rust/dbn/src/publishers.rs`
**Filename:** `publishers.rs`
**Extension:** `.rs`
**Type:** Text

## Original Source

**Location:** `../../../../rust/dbn/src/publishers.rs`
...
This file is located at `rust/dbn/src/publishers.rs` within the repository.
...
**Functions defined:** as_ref, as_str, dataset, deserialize, fmt, from_dataset_venue, from_str, serialize, venue

**Structs defined:** a

**Enums defined:** Dataset, Publisher, Venue
