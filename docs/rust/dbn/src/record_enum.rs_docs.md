# Documentation: rust/dbn/src/record_enum.rs

## File Metadata

**Path:** `rust/dbn/src/record_enum.rs`
**Filename:** `record_enum.rs`
**Extension:** `.rs`
**Type:** Text

## Original Source

**Location:** `../../../../rust/dbn/src/record_enum.rs`
...
This file is located at `rust/dbn/src/record_enum.rs` within the repository.
...
**Functions defined:** from, header, header_mut, raw_index_ts, test_v1_v2_safety, to_owned, try_from

**Enums defined:** RecordEnum, RecordRefEnum, into, value
