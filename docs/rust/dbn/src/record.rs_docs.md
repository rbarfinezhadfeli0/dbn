# Documentation: rust/dbn/src/record.rs

## File Metadata

**Path:** `rust/dbn/src/record.rs`
**Filename:** `record.rs`
**Extension:** `.rs`
**Type:** Text
...
**Location:** `../../../../rust/dbn/src/record.rs`
...
This file is located at `rust/dbn/src/record.rs` within the repository.
...
**Functions defined:** has_rtype, header, header_mut, index_date, index_ts, publisher, raw_index_ts, record_size, rtype, test_alignment_and_no_padding, test_bbo_alignment_matches_mbp1, test_db_ts_always_valid_time_offsetdatetime, test_def_index_ts, test_mbo_index_ts, test_record_object_safe, test_sizes, test_transmute_record, test_transmute_record_bytes, test_transmute_record_bytes_small_buffer, test_transmute_record_mut

**Structs defined:** BboMsg, BidAskPair, CbboMsg, Cmbp1Msg, ConsolidatedBidAskPair, ErrorMsg, ImbalanceMsg, InstrumentDefMsg, MboMsg, Mbp10Msg, Mbp1Msg, OhlcvMsg, RecordHeader, StatMsg, StatusMsg, SymbolMappingMsg, SystemMsg, TradeMsg, WithTsOut

**Enums defined:** which

**Traits defined:** HasRType, Record, RecordMut, for

**Dependencies:** This file imports from 13 modules
...
##### Function: `test_transmute_record_bytes`
...
##### Function: `test_transmute_record_bytes_small_buffer`
