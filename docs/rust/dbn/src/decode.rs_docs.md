# Documentation: rust/dbn/src/decode.rs

## File Metadata

**Path:** `rust/dbn/src/decode.rs`
**Filename:** `decode.rs`
**Extension:** `.rs`
**Type:** Text
...
**Location:** `../../../../rust/dbn/src/decode.rs`
...
This file is located at `rust/dbn/src/decode.rs` within the repository.
...
**Functions defined:** buffer_slice, compat_buffer_slice, decode_record, decode_record_from_ref, decode_record_ref, decode_records, decode_stream, from_file, from_le_slice, get_mut, get_ref, inferred_with_buffer, metadata, metadata_mut, new, new_inferred, poll_read, read, record_ref, skip_bytes

**Structs defined:** DynDecoder, DynReader

**Enums defined:** DynDecoderImpl, DynReaderImpl

**Traits defined:** AsyncSkipBytes, BufferSlice, DbnMetadata, DecodeDbn, DecodeRecord, DecodeRecordRef, DecodeStream, FromLittleEndianSlice, SkipBytes, alias, for

**Dependencies:** This file imports from 19 modules
...
##### Function: `decode_record_from_ref`
