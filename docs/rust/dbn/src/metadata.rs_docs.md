# Documentation: rust/dbn/src/metadata.rs

## File Metadata

**Path:** `rust/dbn/src/metadata.rs`
...
**Location:** `../../../../rust/dbn/src/metadata.rs`
...
This file is located at `rust/dbn/src/metadata.rs` within the repository.
...
**Functions defined:** as_ref, build, builder, dataset, default, deserialize_date, end, limit, mappings, merge, new, not_found, partial, schema, set_version, start, stype_in, stype_out, symbol_map, symbol_map_for_date

**Structs defined:** MappingInterval, Metadata, MetadataBuilder, SymbolMapping, Unset, uses, which
...
```rust
fn set_version(&mut self, input_version: u8, upgrade_policy: VersionUpgradePolicy) {
```
