# Documentation: rust/dbn/src/encode.rs

## File Metadata

**Path:** `rust/dbn/src/encode.rs`
**Filename:** `encode.rs`
**Extension:** `.rs`
**Type:** Text
...
**Location:** `../../../../rust/dbn/src/encode.rs`
...
This file is located at `rust/dbn/src/encode.rs` within the repository.
...
**Functions defined:** async_zstd_encoder, encode_decoded, encode_decoded_with_limit, encode_record, encode_record_ref, encode_record_ref_ts_out, encode_record_with_sym, encode_records, encode_ref_ts_out_with_sym, encode_ref_with_sym, encode_stream, flush, zstd_encoder

**Traits defined:** DbnEncodable, EncodeDbn, EncodeRecord, EncodeRecordRef, EncodeRecordTextExt, for
...
##### Function: `encode_decoded_with_limit`
...
##### Function: `encode_record_with_sym`
...
##### Function: `encode_ref_ts_out_with_sym`

```rust
fn encode_ref_ts_out_with_sym(
        &mut self,
        record: RecordRef,
        ts_out: bool,
        symbol: Option<&str>,
