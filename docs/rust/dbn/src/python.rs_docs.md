# Documentation: rust/dbn/src/python.rs

## File Metadata

**Path:** `rust/dbn/src/python.rs`
**Filename:** `python.rs`
**Extension:** `.rs`
**Type:** Text
...
**Location:** `../../../../rust/dbn/src/python.rs`
...
This file is located at `rust/dbn/src/python.rs` within the repository.
...
**Functions defined:** __iter__, __next__, field_dtypes, from, hidden_fields, into_pyobject, new, ordered_fields, price_fields, py_to_time_date, test_cbbo_fields, test_cbbo_ordered, test_cmbp1_dtypes, test_definition_dtypes, test_definition_fields, test_definition_ordered, test_mbo_dtypes, test_mbo_fields, test_mbo_ordered, test_mbp10_dtypes

**Structs defined:** EnumIterator

**Traits defined:** PyFieldDesc, for
