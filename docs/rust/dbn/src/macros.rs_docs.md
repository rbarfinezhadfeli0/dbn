# Documentation: rust/dbn/src/macros.rs

## File Metadata

**Path:** `rust/dbn/src/macros.rs`
**Filename:** `macros.rs`
**Extension:** `.rs`
**Type:** Text
...
**Location:** `../../../../rust/dbn/src/macros.rs`
...
This file is located at `rust/dbn/src/macros.rs` within the repository.
...
**Functions defined:** do_something, on_rtype, on_rtype_2, test_no_args, test_self, test_two_args

**Structs defined:** Dummy
