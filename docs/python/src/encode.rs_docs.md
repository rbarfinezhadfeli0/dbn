# Documentation: python/src/encode.rs

## File Metadata

**Path:** `python/src/encode.rs`
**Filename:** `encode.rs`
**Extension:** `.rs`
**Type:** Text
...
This file is located at `python/src/encode.rs` within the repository.
...
**Functions defined:** extract_bound, flush, inner, new, py_to_rs_io_err, read, seek, update_encoded_metadata, write

**Structs defined:** MockPyFile, PyFileLike
...
##### Function: `update_encoded_metadata`
