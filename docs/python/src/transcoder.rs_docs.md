# Documentation: python/src/transcoder.rs

## File Metadata

**Path:** `python/src/transcoder.rs`
**Filename:** `transcoder.rs`
**Extension:** `.rs`
**Type:** Text

## Original Source

**Location:** `../../../python/src/transcoder.rs`
...
This file is located at `python/src/transcoder.rs` within the repository.
...
**Functions defined:** buffer, default, downcast_unchecked, encode, encode_csv, encode_dbn, encode_json, flush, get_for_rec, is_empty, maybe_decode_metadata, new, shift_buffer, test_from_test_data_file, test_full_with_partial_record, test_map_symbols_historical, test_map_symbols_live, test_partial_metadata_and_records, update_live, write

**Structs defined:** Inner, Transcoder

**Enums defined:** SymbolMap

**Traits defined:** Transcode

**Dependencies:** This file imports from 11 modules
