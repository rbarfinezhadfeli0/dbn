# Documentation: python/src/dbn_decoder.rs

## File Metadata

**Path:** `python/src/dbn_decoder.rs`
**Filename:** `dbn_decoder.rs`
**Extension:** `.rs`
**Type:** Text

## Original Source

**Location:** `../../../python/src/dbn_decoder.rs`
...
This file is located at `python/src/dbn_decoder.rs` within the repository.
...
**Functions defined:** buffer, decode, new, push_rec, shift_buffer, test_dbn_decoder, test_dbn_decoder_decoding_error, test_dbn_decoder_no_metadata, test_full_with_partial_record, test_partial_metadata_and_records, write

**Structs defined:** DbnDecoder
...
##### Function: `test_partial_metadata_and_records`
...
##### Function: `test_full_with_partial_record`
...
##### Function: `test_dbn_decoder_decoding_error`
