# Documentation: python/python/databento_dbn/v2.py

## File Metadata

**Path:** `python/python/databento_dbn/v2.py`
**Filename:** `v2.py`
**Extension:** `.py`
**Type:** Text
...
**Location:** `../../../../python/python/databento_dbn/v2.py`
...
This file is located at `python/python/databento_dbn/v2.py` within the repository.
...
**Imports:** BBOMsg, CBBOMsg, CMBP1Msg, ErrorMsg, ImbalanceMsg, InstrumentDefMsg, MBOMsg, MBP10Msg, MBP1Msg, OHLCVMsg, StatMsg, StatusMsg, SymbolMappingMsg, SystemMsg, TradeMsg
