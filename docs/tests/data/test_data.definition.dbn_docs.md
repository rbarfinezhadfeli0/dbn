# Documentation: tests/data/test_data.definition.dbn

## File Metadata

**Path:** `tests/data/test_data.definition.dbn`
**Filename:** `test_data.definition.dbn`
**Extension:** `.dbn`
**Type:** Binary

## Original Source

**Location:** `../../../tests/data/test_data.definition.dbn`

## File Type

This is a binary file (test_data.definition.dbn). Binary files are not directly documentable in text form,
