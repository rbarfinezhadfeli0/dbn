# Documentation: tests/data/test_data.trades.dbn

## File Metadata

**Path:** `tests/data/test_data.trades.dbn`
**Filename:** `test_data.trades.dbn`
**Extension:** `.dbn`
**Type:** Binary

## Original Source

**Location:** `../../../tests/data/test_data.trades.dbn`

## File Type

This is a binary file (test_data.trades.dbn). Binary files are not directly documentable in text form,
