# Documentation: tests/data/test_data.definition.dbz

## File Metadata

**Path:** `tests/data/test_data.definition.dbz`
**Filename:** `test_data.definition.dbz`
**Extension:** `.dbz`
**Type:** Binary

## Original Source

**Location:** `../../../tests/data/test_data.definition.dbz`

## File Type

This is a binary file (test_data.definition.dbz). Binary files are not directly documentable in text form,
