# Documentation: tests/data/test_data.tbbo.dbz

## File Metadata

**Path:** `tests/data/test_data.tbbo.dbz`
**Filename:** `test_data.tbbo.dbz`
**Extension:** `.dbz`
**Type:** Binary

## Original Source

**Location:** `../../../tests/data/test_data.tbbo.dbz`

## File Type

This is a binary file (test_data.tbbo.dbz). Binary files are not directly documentable in text form,
