# Documentation: tests/data/test_data.status.dbn

## File Metadata

**Path:** `tests/data/test_data.status.dbn`
**Filename:** `test_data.status.dbn`
**Extension:** `.dbn`
**Type:** Binary

## Original Source

**Location:** `../../../tests/data/test_data.status.dbn`

## File Type

This is a binary file (test_data.status.dbn). Binary files are not directly documentable in text form,
