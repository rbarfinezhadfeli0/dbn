# Documentation: tests/data/test_data.statistics.dbn

## File Metadata

**Path:** `tests/data/test_data.statistics.dbn`
**Filename:** `test_data.statistics.dbn`
**Extension:** `.dbn`
**Type:** Binary

## Original Source

**Location:** `../../../tests/data/test_data.statistics.dbn`

## File Type

This is a binary file (test_data.statistics.dbn). Binary files are not directly documentable in text form,
