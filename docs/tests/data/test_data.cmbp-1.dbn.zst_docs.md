# Documentation: tests/data/test_data.cmbp-1.dbn.zst

## File Metadata

**Path:** `tests/data/test_data.cmbp-1.dbn.zst`
**Filename:** `test_data.cmbp-1.dbn.zst`
**Extension:** `.zst`
**Type:** Binary

## Original Source

**Location:** `../../../tests/data/test_data.cmbp-1.dbn.zst`

## File Type

This is a binary file (test_data.cmbp-1.dbn.zst). Binary files are not directly documentable in text form,
