# Documentation: tests/data/test_data.mbo.dbn

## File Metadata

**Path:** `tests/data/test_data.mbo.dbn`
**Filename:** `test_data.mbo.dbn`
**Extension:** `.dbn`
**Type:** Binary

## Original Source

**Location:** `../../../tests/data/test_data.mbo.dbn`

## File Type

This is a binary file (test_data.mbo.dbn). Binary files are not directly documentable in text form,
