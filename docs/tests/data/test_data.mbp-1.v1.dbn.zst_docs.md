# Documentation: tests/data/test_data.mbp-1.v1.dbn.zst

## File Metadata

**Path:** `tests/data/test_data.mbp-1.v1.dbn.zst`
**Filename:** `test_data.mbp-1.v1.dbn.zst`
**Extension:** `.zst`
**Type:** Binary

## Original Source

**Location:** `../../../tests/data/test_data.mbp-1.v1.dbn.zst`

## File Type

This is a binary file (test_data.mbp-1.v1.dbn.zst). Binary files are not directly documentable in text form,
