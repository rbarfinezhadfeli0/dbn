# Documentation: tests/data/test_data.ohlcv-1m.dbz

## File Metadata

**Path:** `tests/data/test_data.ohlcv-1m.dbz`
**Filename:** `test_data.ohlcv-1m.dbz`
**Extension:** `.dbz`
**Type:** Binary

## Original Source

**Location:** `../../../tests/data/test_data.ohlcv-1m.dbz`

## File Type

This is a binary file (test_data.ohlcv-1m.dbz). Binary files are not directly documentable in text form,
