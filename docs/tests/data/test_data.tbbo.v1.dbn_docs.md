# Documentation: tests/data/test_data.tbbo.v1.dbn

## File Metadata

**Path:** `tests/data/test_data.tbbo.v1.dbn`
**Filename:** `test_data.tbbo.v1.dbn`
**Extension:** `.dbn`
**Type:** Binary

## Original Source

**Location:** `../../../tests/data/test_data.tbbo.v1.dbn`

## File Type

This is a binary file (test_data.tbbo.v1.dbn). Binary files are not directly documentable in text form,
