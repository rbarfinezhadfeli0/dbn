# Documentation: tests/data/test_data.definition.v1.dbn.frag.zst

## File Metadata

**Path:** `tests/data/test_data.definition.v1.dbn.frag.zst`
**Filename:** `test_data.definition.v1.dbn.frag.zst`
**Extension:** `.zst`
**Type:** Binary

## Original Source

**Location:** `../../../tests/data/test_data.definition.v1.dbn.frag.zst`

## File Type

This is a binary file (test_data.definition.v1.dbn.frag.zst). Binary files are not directly documentable in text form,
