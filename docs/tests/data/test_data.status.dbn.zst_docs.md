# Documentation: tests/data/test_data.status.dbn.zst

## File Metadata

**Path:** `tests/data/test_data.status.dbn.zst`
**Filename:** `test_data.status.dbn.zst`
**Extension:** `.zst`
**Type:** Binary

## Original Source

**Location:** `../../../tests/data/test_data.status.dbn.zst`

## File Type

This is a binary file (test_data.status.dbn.zst). Binary files are not directly documentable in text form,
