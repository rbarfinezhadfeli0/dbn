# Documentation: tests/data/test_data.tbbo.dbn

## File Metadata

**Path:** `tests/data/test_data.tbbo.dbn`
**Filename:** `test_data.tbbo.dbn`
**Extension:** `.dbn`
**Type:** Binary

## Original Source

**Location:** `../../../tests/data/test_data.tbbo.dbn`

## File Type

This is a binary file (test_data.tbbo.dbn). Binary files are not directly documentable in text form,
