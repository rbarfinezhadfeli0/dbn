# Documentation: tests/data/test_data.ohlcv-1h.dbz

## File Metadata

**Path:** `tests/data/test_data.ohlcv-1h.dbz`
**Filename:** `test_data.ohlcv-1h.dbz`
**Extension:** `.dbz`
**Type:** Binary

## Original Source

**Location:** `../../../tests/data/test_data.ohlcv-1h.dbz`

## File Type

This is a binary file (test_data.ohlcv-1h.dbz). Binary files are not directly documentable in text form,
