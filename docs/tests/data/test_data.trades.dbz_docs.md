# Documentation: tests/data/test_data.trades.dbz

## File Metadata

**Path:** `tests/data/test_data.trades.dbz`
**Filename:** `test_data.trades.dbz`
**Extension:** `.dbz`
**Type:** Binary

## Original Source

**Location:** `../../../tests/data/test_data.trades.dbz`

## File Type

This is a binary file (test_data.trades.dbz). Binary files are not directly documentable in text form,
