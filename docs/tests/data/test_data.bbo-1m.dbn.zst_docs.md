# Documentation: tests/data/test_data.bbo-1m.dbn.zst

## File Metadata

**Path:** `tests/data/test_data.bbo-1m.dbn.zst`
**Filename:** `test_data.bbo-1m.dbn.zst`
**Extension:** `.zst`
**Type:** Binary

## Original Source

**Location:** `../../../tests/data/test_data.bbo-1m.dbn.zst`

## File Type

This is a binary file (test_data.bbo-1m.dbn.zst). Binary files are not directly documentable in text form,
