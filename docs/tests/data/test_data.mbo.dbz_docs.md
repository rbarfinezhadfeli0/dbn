# Documentation: tests/data/test_data.mbo.dbz

## File Metadata

**Path:** `tests/data/test_data.mbo.dbz`
**Filename:** `test_data.mbo.dbz`
**Extension:** `.dbz`
**Type:** Binary

## Original Source

**Location:** `../../../tests/data/test_data.mbo.dbz`

## File Type

This is a binary file (test_data.mbo.dbz). Binary files are not directly documentable in text form,
