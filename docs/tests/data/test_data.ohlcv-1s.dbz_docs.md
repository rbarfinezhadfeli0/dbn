# Documentation: tests/data/test_data.ohlcv-1s.dbz

## File Metadata

**Path:** `tests/data/test_data.ohlcv-1s.dbz`
**Filename:** `test_data.ohlcv-1s.dbz`
**Extension:** `.dbz`
**Type:** Binary

## Original Source

**Location:** `../../../tests/data/test_data.ohlcv-1s.dbz`

## File Type

This is a binary file (test_data.ohlcv-1s.dbz). Binary files are not directly documentable in text form,
