# Documentation: tests/data/test_data.mbp-10.dbz

## File Metadata

**Path:** `tests/data/test_data.mbp-10.dbz`
**Filename:** `test_data.mbp-10.dbz`
**Extension:** `.dbz`
**Type:** Binary

## Original Source

**Location:** `../../../tests/data/test_data.mbp-10.dbz`

## File Type

This is a binary file (test_data.mbp-10.dbz). Binary files are not directly documentable in text form,
