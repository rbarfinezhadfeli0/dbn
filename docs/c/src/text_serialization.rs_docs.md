# Documentation: c/src/text_serialization.rs

## File Metadata

**Path:** `c/src/text_serialization.rs`
**Filename:** `text_serialization.rs`
**Extension:** `.rs`
**Type:** Text

## Original Source

**Location:** `../../../c/src/text_serialization.rs`
...
This file is located at `c/src/text_serialization.rs` within the repository.
...
**Functions defined:** f_serialize_record, f_serialize_record_header, s_serialize_record, s_serialize_record_header, schema_from_rtype, serialize_csv_header, test_serialize_def_v1, test_serialize_def_v2, test_serialize_def_v3, write_null_and_ret

**Structs defined:** SerializeRecordOptions

**Enums defined:** SerializeError, TextEncoding
...
##### Function: `s_serialize_record_header`

```rust
fn s_serialize_record_header(
    buffer: *mut c_char,
    length: libc::size_t,
    record: *const RecordHeader,
    options: *const SerializeRecordOptions,
...
##### Function: `f_serialize_record_header`

```rust
fn f_serialize_record_header(
    file: *mut libc::FILE,
    record: *const RecordHeader,
    options: *const SerializeRecordOptions,
) -> libc::c_int {
...
##### Function: `s_serialize_record`

```rust
fn s_serialize_record(
    buffer: *mut c_char,
    length: libc::size_t,
    record: *const RecordHeader,
    options: *const SerializeRecordOptions,
...
##### Function: `f_serialize_record`

```rust
fn f_serialize_record(
    file: *mut libc::FILE,
    record: *const RecordHeader,
    options: *const SerializeRecordOptions,
) -> libc::c_int {
...
##### Function: `schema_from_rtype`

```rust
fn schema_from_rtype(rtype: u8, res: *mut Schema) -> bool {
```


##### Function: `serialize_csv_header`
...
##### Function: `test_serialize_def_v1`
...
##### Function: `test_serialize_def_v2`
...
##### Function: `test_serialize_def_v3`
